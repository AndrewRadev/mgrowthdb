...
If you'd like to share the "Visualize" page of your workspace, you can just send the URL of the page, but it's also possible to build a particular chart and click on the "Copy link to page" button below the chart. This will copy a URL to this particular configuration of chart traces to your clipboard.
