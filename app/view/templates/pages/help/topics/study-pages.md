...
From this page, you can click on "Copy link to chart" button to get a link to this configuration of data traces and send it to other researchers for the purposes of collaboration. You could also add the charts to the "Compare" view by clicking on the bottom-right "Compare across studies" button seen in that same figure.
